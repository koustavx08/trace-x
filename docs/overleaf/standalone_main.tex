...
% ---------------------------------------------------------------------------
% EMBEDDED BIBLIOGRAPHY (1-FILE OVERLEAF COMPATIBLE)
% ---------------------------------------------------------------------------
\begin{thebibliography}{99}

\bibitem{ron2013quantitative}
D.~Ron and A.~Shamir, ``Quantitative analysis of the full bitcoin transaction graph,'' in \emph{Financial Cryptography and Data Security}, pp.~6--24, Springer, 2013.

\bibitem{meiklejohn2013fistful}
S.~Meiklejohn, M.~Pomarole, G.~Jordan, K.~Levchenko, D.~McCoy, G.~M. Voelker, and S.~Savage, ``A fistful of bitcoins: Characterizing payments among men with no names,'' in \emph{Proc. ACM IMC}, pp.~127--140, 2013.

\bibitem{reid2013analysis}
F.~Reid and M.~Harrigan, ``An analysis of anonymity in the bitcoin system,'' in \emph{Security and Privacy in Social Networks}, pp.~197--223, Springer, 2013.

\bibitem{weber2019anti}
M.~Weber, J.~Chen, S.~Toyer, C.~Bellei, P.~Biscaro, T.~Kaler, S.~Fard, and C.~Faloutsos, ``Anti-money laundering in bitcoin: Experimenting with graph convolutional networks for financial forensics,'' \emph{arXiv preprint arXiv:1908.02591}, 2019.

\bibitem{biryukov2019deanonymization}
A.~Biryukov and S.~Tikhomirov, ``Deanonymization and linkability in cryptocurrency networks: A survey,'' \emph{IEEE Communications Surveys \& Tutorials}, vol.~21, no.~4, pp.~3814--3836, 2019.

\bibitem{moser2018anonymous}
M.~M{\"o}ser, R.~B{\"o}hme, and D.~Breuker, ``An inquiry into money laundering tools in the bitcoin ecosystem,'' in \emph{IEEE e-Crime Researchers Summit (eCRS)}, pp.~1--14, 2013.

\bibitem{qin2021quantifying}
K.~Qin, L.~Zhou, B.~Livshits, and A.~Gervais, ``Quantifying blockchain extractable value: How dark is the forest?'' in \emph{IEEE Symposium on Security and Privacy (S\&P)}, pp.~198--214, 2022.

\bibitem{wang2022towards}
D.~Wang, B.~Jiang, J.~Shen, and Q.~Wang, ``Towards understanding flash loan attacks in defi: Concepts, framework, and empirical analysis,'' in \emph{IEEE ICBC}, pp.~1--9, 2022.

\bibitem{fatf2019guidance}
{Financial Action Task Force (FATF)}, ``Guidance for a risk-based approach to virtual assets and virtual asset service providers,'' FATF/OECD, Paris, France, Tech. Rep., 2019.

\bibitem{fatf2021updated}
{Financial Action Task Force (FATF)}, ``Updated guidance for a risk-based approach to virtual assets and virtual asset service providers (Recommendation 16),'' FATF/OECD, Paris, France, Tech. Rep., 2021.

\bibitem{fiu_ind_2023}
{Financial Intelligence Unit - India (FIU-IND)}, ``Anti-money laundering and countering the financing of terrorism guidelines for virtual digital asset service providers,'' Ministry of Finance, Govt. of India, Tech. Rep., 2023.

\bibitem{pmla_act_2002}
{Parliament of India}, ``The Prevention of Money Laundering Act, 2002 (PMLA),'' Act No. 15 of 2003, Government of India, 2002.

\bibitem{indian_evidence_act_1872}
{Law Commission of India}, ``The Indian Evidence Act, 1872: Section 65B (Admissibility of Electronic Records),'' as amended by Information Technology Act, 2000; Replaced by Bharatiya Sakshya Adhiniyam (BSA), 2023, Section 63.

\bibitem{it_act_2000}
{Ministry of Electronics and Information Technology (MeitY)}, ``The Information Technology Act, 2000: Sections 43A, 69, 79,'' Government of India, 2000.

\bibitem{anshul2020admissibility}
A.~Anshul and R.~Sharma, ``Admissibility of electronic evidence in India: An analytical study of Section 65B,'' \emph{Supreme Court Cases (Journal Section)}, vol.~8, pp.~24--41, 2020.

\bibitem{alarab2020competence}
I.~Alarab, S.~Praveen, and S.~Zubair, ``Competence of graph convolutional networks for anti-money laundering in cryptocurrencies,'' in \emph{Proc. ACM ICIEA}, pp.~23--28, 2020.

\bibitem{kiffer2018under}
L.~Kiffer, D.~Levin, and A.~Mislove, ``Under the hood of the ethereum blockchain: Analysis of smart contracts and mining behavior,'' in \emph{Proc. ACM IMC}, pp.~275--288, 2018.

\bibitem{victor2020address}
F.~Victor, ``Address clustering heuristics for ethereum,'' in \emph{Financial Cryptography and Data Security}, pp.~617--633, Springer, 2020.

\bibitem{chainalysis2024crypto}
{Chainalysis Inc.}, ``The 2024 crypto crime report: Key trends in ransomware, darknet markets, and sanctions evasion,'' Chainalysis Research, Tech. Rep., 2024.

\bibitem{elliptic2023typhoon}
{Elliptic Enterprises Ltd.}, ``Cross-chain crime: The new frontier in blockchain money laundering,'' Elliptic Connect, Tech. Rep., 2023.

\bibitem{sarmah2022survey}
S.~Sarmah, S.~Borgohain, and R.~Patgiri, ``A comprehensive survey on blockchain forensics: Tools, techniques, and challenges,'' \emph{Journal of Network and Computer Applications}, vol.~205, p.~103447, 2022.

\bibitem{nist_sp800_86}
K.~Kent, S.~Chevalier, T.~Grance, and H.~Dang, ``Guide to integrating forensic techniques into incident response,'' NIST Special Publication 800-86, Tech. Rep., 2006.
