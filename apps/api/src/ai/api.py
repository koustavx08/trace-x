...
async def get_ai_capabilities():
    ...
    descriptions = {
        "live": "Responses are generated by the Anthropic Claude API.",
        "demo": "Responses are generated from deterministic templates over real "
        "investigation evidence (no live LLM call) - either ANTHROPIC_API_KEY is "
        "not configured, or AI_MODE=demo was set explicitly.",
        "disabled": "AI assistance is disabled on this deployment (AI_MODE=disabled). "
        "The rest of TRACE-X continues to function normally.",
    }
    return {
        "mode": mode,
        "model": _settings.ANTHROPIC_MODEL if mode == "live" else None,
